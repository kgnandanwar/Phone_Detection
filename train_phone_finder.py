...
def create_labeled_examples_training_testing(folder, seed=0, half_window_side_normalized=0.1):
    ...
    # print(image_paths_training, image_paths_testing)
...
def test_model(X_testing, images_testing,
    ...
    show_examples(list(zip(images_testing, yhat_testing)), 'predicted labels:')
...
def train_and_test_model(folder):
    ...
    images_training, labels_training = list(zip(*labeled_examples_training))
    images_testing, labels_testing = list(zip(*labeled_examples_testing))
    # print("c")
